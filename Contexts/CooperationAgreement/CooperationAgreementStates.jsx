...
const CooperationAgreementStates = (props) => {
  const initialState = {
    ...
    , tab_3 : {1:{'25':1,'30':1,'31':2,'32':2,'38':2,'39':2,validations:{'34':{'type':1,validate:false},'35':{'type':2,validate:false}}},2:{'25':1,'30':1,'31':2,'32':2,'38':2,'39':2,validations:{'34':{'type':1,validate:false},'35':{'type':2,validate:false}}},loaded:true,}
    ...
    , tab_6:  {'56':1,'57':2,'58':1,'61':2,'62':2,'63':2,'64':2,'65':2,'73':2,'74':1,'76':2,'77':2,'78':2,'79':2,
       validations:{'54':{'type':1,validate:false},'55':{'type':2,validate:false} }
     }
    , selectedTabId: 1
    , loadedTabs: []
