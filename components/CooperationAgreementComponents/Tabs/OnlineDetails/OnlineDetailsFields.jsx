...
export const onlineDetaillsRadioRow1 = [
  {id:43,key_name:'Online prestatie',option1:'Yes',option2:'No'},
  {id:44,key_name:'Prestatieblad',option1:'Yes',option2:'No'},
];

export const onlineDetaillsRadioRow2 = [
  {id:48,key_name:'Digital contract',option1:'Yes',option2:'No'},
  {id:49,key_name:'New online encodage',option1:'Yes',option2:'No'},
];
