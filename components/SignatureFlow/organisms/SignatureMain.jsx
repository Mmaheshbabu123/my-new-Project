  ...
  return (
    ...
    {state.loaded === true ?
      <>
        ...
        <button onClick={() => router.push('/')} type="button" className="bg-white border-0 poppins-regular-18px float-sm-right mt-5 mb-2 ps-0 text-decoration-underline text-uppercase">
          {`BACK`}
        </button>
      </>
    : <p>Loading...</p>}
