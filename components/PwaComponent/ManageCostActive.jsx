...
import { ManagecostcenterActive } from '../../Services/ApiEndPoints';
import { useEffect, useState } from 'react';
import Pagination from "../PcComponent/Pagination";

function ManageCostActive(props) {
    const { t } = props;
    ...
    useEffect(
        () => {
            APICALL.service(ManagecostcenterActive, 'GET')
                .then((result) => {
...
// export default  ManageCostActive();
export default React.memo(Translation(ManageCostActive, ['Manage locations', 'Add location', 'Search', 'Location', 'Company', 'Action', 'Aartselaar', 'The awkward antique store']));
