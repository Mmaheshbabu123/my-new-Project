...
import { inactiveTab } from '../../Services/ApiEndPoints';
import { useEffect, useState } from 'react';
import Pagination from "../PcComponent/Pagination";



function ManageInactiveTab(props) {
    const { t, searchpc, sendvalue } = props;
    ...
    useEffect(
        () => {
            APICALL.service(inactiveTab, 'GET')
                .then((result) => {
...
export default React.memo(Translation(ManageInactiveTab, ['Manage locations', 'Add location', 'Search', 'Location', 'Company', 'Action', 'Aartselaar', 'The awkward antique store']));
