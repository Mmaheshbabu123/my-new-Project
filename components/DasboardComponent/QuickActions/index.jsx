        ...
        <>
            <div className="flex-row-action col-12 mt-5">
                ...
                <a href="#" alt="Edit actions">
                    <img className="edit-actions ml-3 mb-1" src="/img/edit-action.svg" alt="Edit actions" />
                </a>
            </div>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/mycontract">
                        <a href="#" title="Mijn contracten">
                            <img className="card-img-top" src="/img/file-contract.svg" alt="Mijn contracten details" />
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Mijn gegevens">
                            <img className="card-img-top" src="/img/mydetails.svg" alt="Mijn gegevens details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a className="col" href="#" title="Mijn watermeter">
                            <img className="card-img-top" src="/img/meter.svg" alt="Mijn watermeter details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a className="col" href="#" title="Lek melden">
                            <img className="card-img-top" src="/img/leak.svg" alt="Lek melden details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/mycontract">
                        <a className="col" href="/mycontract" title="Verhuizen">
                            <img className="card-img-top" src="/img/move-away.svg" alt="Verhuizen details" />
                            <div className="card-body">
            ...
            <div className="card-deck deck-1 mt-5 flex" style={{ display: showMe?"flex":"none" }}>
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Nieuw contract">
                            <img className="card-img-top" src="/img/new-contract.svg" alt="Nieuw contract details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Doccle">
                            <img className="card-img-top" src="/img/doccle.svg" alt="Doccle details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Rapporteer probleem">
                            <img className="card-img-top" src="/img/report-problem.svg" alt="Rapporteer probleem details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Mijn gelinkte accounts">
                            <img className="card-img-top" src="/img/settings.svg" alt="Mijn gelinkte accounts details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Domiciliëring aanvragen">
                            <img className="card-img-top" src="/img/direct-debit.svg" alt="Domiciliëring aanvragen details" />
                            <div className="card-body">
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Inspectie aanvragen">
                            <img className="card-img-top" src="/img/inspection.svg" alt="Inspectie aanvragen details" />
                            <div className="card-body">
            ...
            <div className="flex justify-content-center mt-5 mb-5">
              <a className="tahoma-regular-normal-azure-28px flex gap" href="#card-deck" onClick={toggle}>
                ...
                <div className="flex mt-1">
                    <img className="arrow-ios-downward-fill deck-hide" style={{ display: !showMe ? "flex" : "none" }} src="/img/arrow-ios-downward-fill-3@1x.png" alt="Bekijk meer down"/>
                    <img className="arrow-ios-upward-fill deck-1" style={{ display: showMe? "flex" : "none" }} src="/img/arrow-ios-downward-fill-6@1x.png" alt="Bekijk meer up"/>
                </div>
              </a>
            </div>
        <div className='custom-minus-margin'>
            ...
            <div className="overlap-group-container  col-12 footer-background-sec px-5">
                <div className="overlap-group44 border-2px-silver col-8">
                    <img alt="consumption-image" className="" src="/img/consumption_blue.svg" />
                        ...
                        <div className="text-bel tahoma-bold-gravel-26px d-flex align-items-center">Mijn verbruik</div>
                            <div className="overlap-group11 col-12 d-flex">
                                ...
                                <div className="col-1 d-flex align-items-center justify-content-center ">
                                    <img alt="downarrow-image" className="down-arrow-img" src="/img/down-arrow.png" />
                                </div>
                            </div>  
                            <div className='col-12 d-flex'>
                                ...
                                <div className='col-4 flex justify-content-end'>
                                    <img alt="drupi-image" className="drupi_img" src="/img/drupi.svg" />
                                </div>
                            </div> 
                        </div>
                    </div>
                <div className="card overlap-group2-dashboard1 border-2px-silver col-4">
                    <div className='d-flex align-items-center mb-2'>
                         <img alt="Mijn notificaties" className="icon-material-message2 mr-5" src="/img/notification@1l.svg" />
                         <span className='text-bel tahoma-bold-gravel-26px '>Mijn notificaties</span>
                    </div>
                    <div className='col-12 d-flex mt-4'>
                       <span><img alt="notification-image" className="dark_notifi_img mr-5 ml-2" src="/img/notification-black.svg" /></span> 
                        <div>
            ...
            <div className="search-wrapper border-2px-silver flex pl-4 pr-2 py-3 align-items-center mt-3 container">
                <a href="#"><img alt="Search" class="search-img" src="/img/search.svg" /></a>
                <div class="form-outline tahoma-regular-normal-gravel-28px col-11 px-4">
                    <input type="search" id="form1" placeholder="Zoekopdracht" class="boxshadow-none border-0 form-control" />
                    <label class="form-label d-none" for="form1">zoekopdracht</label>
                </div>
                {/* <div className="tahoma-regular-normal-gravel-28px col-11 px-4"></div> */}
                <a href="#"><img alt="Next" class="icon-ionic-ios-arrow-up" src="/img/icon-ionic-ios-arrow-up-1@1x.png" /></a>
            </div>
        </>
    );
};
