    ...
    return (
        <>
            <div className="flex-row-action col-12 mt-5">
                <span className="my-quick-actions tahoma-bold-gravel-30px">{t('Mijn snelle acties')}</span>
                    ...
                    <Link href="/mycontract">
                        <a href="#" title="Mijn contracten">
                            ...
                            <div className="card-body">
                                <h2 className="card-title tahoma-regular-normal-gravel-28px">{t('Mijn contracten')}</h2>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                </div>
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Mijn gegevens">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Mijn gegevens')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a className="col" href="#" title="Mijn watermeter">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Mijn watermeter')}</h3>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a className="col" href="#" title="Lek melden">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Lek melden')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/mycontract">
                        <a className="col" href="/mycontract" title="Verhuizen">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Verhuizen')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Nieuw contract">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Nieuw contract')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Doccle">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Doccle')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Rapporteer probleem">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Rapporteer probleem')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Mijn gelinkte accounts">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Mijn gelinkte accounts')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Domiciliëring aanvragen">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Domiciliëring aanvragen')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
                ...
                <div className="card px-2 py-4 border-2px-silver">
                    <Link href="/myoverview">
                        <a href="#" title="Inspectie aanvragen">
                            ...
                            <div className="card-body">
                                <h3 className="card-title tahoma-regular-normal-gravel-28px">{t('Inspectie aanvragen')}</h3>
                                <p className="card-text  tahoma-regular-normal-gravel-24px">{t('Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor')}</p>
                            </div>
                        </a>
                    </Link>
            ...
            <div className="flex justify-content-center mt-5 mb-5">
              <a className="tahoma-regular-normal-azure-28px flex gap" href="#card-deck" onClick={toggle}>
                  <span style={{ display: !showMe ? "flex" : "none" }}>{t('Bekijk meer')}</span>
                  <span style={{ display: showMe? "flex" : "none" }}>{t('Bekijk minder')}</span>
        ...
        <div className='custom-minus-margin'>
            ...
            <div className="overlap-group-container  col-12 footer-background-sec px-5">
                <div className="overlap-group44 border-2px-silver col-8">
                    ...
                    <div className="flex-col-1 col-8">
                        <div className="text-bel tahoma-bold-gravel-26px d-flex align-items-center">{t('Mijn verbruik')}</div>
                            <div className="overlap-group11 col-12 d-flex">
                                <div className="col-11 p-3 lh-base">
                                    <span className="tahoma-regular-normal-gravel-24px d-flex">{t('Driesplein 6')} </span>
                                    <span className="tahoma-regular-normal-gravel-24px d-flex mb-2">{t('1930 Zaventem, België')}</span>
                                    <span className="tahoma-regular-normal-gravel-24px d-flex">{t('Meter number 180483036')}</span>
                                </div>
                            ...
                            <div className='col-12 d-flex'>
                                <div className='col-12'>
                                    <div className='col-12 mt-3 mb-3'><p className='tahoma-regular-normal-gravel-24px'>{t('Verbruik vorige maand: 230.00m3')}</p></div>
                                      <div className='col-12 mt-2 mb-2'>
                                        <p className='tahoma-regular-normal-gravel-24px my-1 mb-2'>{t('Verbruik huidige maand: 220.00m3')}</p>
                                        <p className='tahoma-regular-normal-gravel-24px my-1'>{t('Huidige maand: 25/11/2021, 12:30')}</p>
                                      </div>  
                                 </div>
                ...
                <div className="card overlap-group2-dashboard1 border-2px-silver col-4">
                    <div className='d-flex align-items-center mb-2'>
                         ...
                         <span className='text-bel tahoma-bold-gravel-26px '>{t('Mijn notificaties')}</span>
                    </div>
                    <div className='col-12 d-flex mt-4'>
                       <span><Image alt="notification-image" className="dark_notifi_img mr-5 ml-2" src="/img/notification-black.svg" /></span> 
                        <div>
                            <p className='tahoma-regular-normal-gravel-24px mb-2'>{t('Er is een nieuw contract geactiveerd')} </p>
                            <p className='tahoma-regular-normal-gravel-24px mb-3'>{t('met contract nummer: 8316.')}</p>
                            <p className='tahoma-regular-normal-gravel-22px'>{t('20 mei 2021')}</p>
                        </div>
                     </div>
                     <div className='col-12 d-flex mt-4'>
                        <span><Image alt="notification-image" className="dark_notifi_img mr-5 ml-2" src="/img/notification-black.svg" /></span>
                        <div>
                            <p className='tahoma-regular-normal-gravel-24px mb-2'>{t('We hebben de betaling van')} </p>
                            <p className='tahoma-regular-normal-gravel-24px mb-3'>{t('factuur met factuurnummer: 1021')}</p>
                            <p className='tahoma-regular-normal-gravel-22px'>{t('18 mei 2021')}</p>
                        </div>
                     </div>
            ...
            <div className="mt-5 mb-5 text-center tahoma-bold-gravel-30px">{t('Heb je een vraag? Typ ze in de zoekbalk en we zoeken het voor je uit!')}</div>
            <div className="search-wrapper border-2px-silver flex pl-4 pr-2 py-3 align-items-center mt-3 container">
                ...
                <div className="form-outline tahoma-regular-normal-gravel-28px col-11 px-4">
                    ...
                    <label className="form-label d-none" htmlFor="form1">{t('zoekopdracht')}</label>
                </div>
...
export default React.memo(Translation(QuickActions,['Mijn snelle acties','Mijn contracten','Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor',
'Mijn gegevens','Lorem ipsum dolor sit amet consetetur sadipscing elitr sed diam nonumy eirmod tempor','Mijn watermeter','Lek melden','Verhuizen','Nieuw contract','Doccle',
'Rapporteer probleem','Mijn gelinkte accounts','Domiciliëring aanvragen','Inspectie aanvragen','Bekijk meer','Bekijk minder','Mijn verbruik','Driesplein 6','1930 Zaventem, België','Meter number 180483036',
'Verbruik vorige maand: 230.00m3','Verbruik huidige maand: 220.00m3','Huidige maand: 25/11/2021, 12:30','Mijn notificaties','Er is een nieuw contract geactiveerd','met contract nummer: 8316.','20 mei 2021'
,'We hebben de betaling van','factuur met factuurnummer: 1021','18 mei 2021','Bekijk meer','Heb je een vraag? Typ ze in de zoekbalk en we zoeken het voor je uit!','zoekopdracht'
]));
