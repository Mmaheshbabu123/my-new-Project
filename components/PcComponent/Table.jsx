						...
						<tr>
							...
							<td className="text-end " rowSpan="2">
								...
								>
									{props.type == 'editpc' &&
									props.sectype == 'pc' && (
										<FaEdit data-toggle="tooltip" title="Edit paritair comite" />
									)}
								</div>
								...
								>
									{props.sectype == 'pc' &&
									props.type != 'addpc' && <GrRotateRight data-toggle="tooltip" title="Edit age" />}
								</div>
								<div
									onClick={() => {
										editSec('emp_type');
								...
								>
									{props.sectype == 'pc' &&
									props.type != 'addpc' && (
										<MdOutlineGroups data-toggle="tooltip" title="Edit employee type" />
									)}
								</div>
								<div
									onClick={() => {
								...
								>
									{props.sectype == 'pc' &&
									props.type != 'addpc' && (
										<RiHandCoinLine data-toggle="tooltip" title="Edit salary benefits" />
									)}
								</div>
							</td>
						</tr>
