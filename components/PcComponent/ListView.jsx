...
const ListView = (props) => {
	...
	return (
		<li key={props.index} className= {`list-inline-item ${props.level=='3'?styles.section_func_li:styles.sectionli} ${props.level=='3'?styles.section_funct:styles.section_cat} hi sectioncolor`}>
			{header && (
				<div
